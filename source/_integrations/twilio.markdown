...
To be able to receive events from Twilio, Home Assistant needs to be accessible from the internet. You may use Nabu Casa/HA Cloud, or you will need to have your external URL [configured](/docs/configuration/basic) in Home Assistant..
